...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <p className="pb-6">
        Zde můžeš libovolně skládat vlaky a přenášet vozy z jedné koleje na druhou. Tyto data se následně
        přepisují do Exportu dat, kde můžeš data vyexportovat do formátu Excel.
      </p>
      <h3 className="text-h3 font-bold">Odstavené vozy</h3>
      <p className="pb-6">
        V této záložce můžeš vytvářet koleje nebo místa, kde se právě nachází nějaké soupravy. Můžeš zde také
        přetahovat vozy a lokomotivy mezi jednotlivými místy.
      </p>
