...
const ChooseClassMenu = ({ isHoveredClass, handleClassColor, isDarkMode, darkHover }: IChooseClassMenuProps) => (
  <div className={clsx("flex justify-between items-center w-full px-4 py-2 gap-4", darkHover)}>
    ...
    {isHoveredClass && <MultiMenu isColorClass={true} classColor={handleClassColor} isDarkMode={isDarkMode} />}
  </div>
);
